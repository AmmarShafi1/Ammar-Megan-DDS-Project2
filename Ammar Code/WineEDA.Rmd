...
features <- wine_data[, c("residual.sugar", "pH", "density", "alcohol")]
...
# 1.5 Alcohol vs Sugar (Increasing Trend)
ggplot(wine_data, aes(x = residual.sugar, y = alcohol)) +
  geom_point(alpha = 0.6, color = "blue") +
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  theme_minimal() +
  labs(title = "Sugar vs Alcohol", x = "Residual Sugar", y = "Alcohol")
